...
docker run --name=messenger-couchdb -p 5985:5984 --net=messenger-network -v $DIR/data/couchdb:/usr/local/var/lib/couchdb -e COUCHDB_USER=root -e COUCHDB_PASSWORD=$COUCHDB_PASSWORD -d jfonzuer/messenger-couchdb
