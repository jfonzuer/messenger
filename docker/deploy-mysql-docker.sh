...
docker run --name=messenger-mysql --net=messenger-network -p 3307:3306 -v $DIR/data/mysql:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=$MYSQL_PASSWORD -e MYSQL_DATABASE=messenger  -d jfonzuer/messenger-mysql
